...
export const ROLE_PERMISSIONS: Record<string, {
  ...
  doctor: {
    ...
    menuItems: ['dashboard', 'patients', 'appointments', 'visits', 'labs', 'prescriptions'],
  },
  receptionist: {
    label: 'Receptionist',
    ...
    menuItems: ['dashboard', 'patients', 'appointments', 'invoices'],
  },
  nurse: {
    label: 'Nurse',
    ...
    menuItems: ['dashboard', 'patients', 'visits'],
  },
  cashier: {
    label: 'Cashier',
